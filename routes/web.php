...
Route::middleware(['auth', 'not_suspended'])->group(function () {
    ...
    Route::get('/premium/insight', [\App\Http\Controllers\PremiumInsightController::class, 'index'])
    ...
    Route::middleware('role:admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('commodities/{commodity}/prices', [\App\Http\Controllers\Admin\CommodityController::class, 'storePrice'])->name('commodities.storePrice');
