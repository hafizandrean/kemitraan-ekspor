...
if ($darkNav ?? false) {
    $classes = ($active ?? false)
        ...
        : 'inline-flex items-center px-2.5 py-1.5 rounded-lg text-xs font-medium text-exportani-mint/90 hover:text-white hover:bg-white/10 transition duration-150 ease-out';
} else {
    $classes = ($active ?? false)
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-exportani-primary text-sm font-semibold leading-5 text-exportani-primary focus:outline-none transition duration-150 ease-in-out'
