<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <select id="role" name="role" required class="mt-1.5 block w-full rounded-lg border-stone-300 bg-white text-stone-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">
